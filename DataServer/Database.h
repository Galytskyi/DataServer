...
{
	"ALTER TABLE Devices ADD CoordLatitude VARCHAR(64);",		// 1
...
const int				SqlObjectID[SQL_TABLE_COUNT] =
{
						...
						100,		//	SQL_TABLE_DEVICE

						200,		//	SQL_TABLE_PICTURE_INFO
						201,		//	SQL_TABLE_PICTURE
};
