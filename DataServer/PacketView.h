...
{
							QT_TRANSLATE_NOOP("PacketView.h", "IMEI"),
							QT_TRANSLATE_NOOP("PacketView.h", "Location"),
							QT_TRANSLATE_NOOP("PacketView.h", "Reg. Time"),
							QT_TRANSLATE_NOOP("PacketView.h", "Brightness"),
							QT_TRANSLATE_NOOP("PacketView.h", "Size"),
};

const int					PACKET_VIEW_COLUMN_COUNT	 = sizeof(PacketViewColumn)/sizeof(PacketViewColumn[0]);

const int					PACKET_VIEW_COLUMN_IMEI		= 0,
							PACKET_VIEW_COLUMN_LOCATION	= 1,
							PACKET_VIEW_COLUMN_TIME		= 2,
							PACKET_VIEW_COLUMN_BRIGHT	= 3,
							PACKET_VIEW_COLUMN_SIZE		= 4;

const int					PacketViewWidth[PACKET_VIEW_COLUMN_COUNT] =
{
							100,	// PACKET_VIEW_COLUMN_IMEI
							150,	// PACKET_VIEW_COLUMN_LOCATION
							150,	// PACKET_VIEW_COLUMN_TIME
							100,	// PACKET_VIEW_COLUMN_BRIGHT
							100,	// PACKET_VIEW_COLUMN_SIZE
};
